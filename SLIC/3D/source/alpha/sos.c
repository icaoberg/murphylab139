...
#ifndef lint
  static char version[] = "@(#) SoS Library 1.3";
...
void sos_matrix (n0, d, scale, len, lenp)
     int n0, d;
     double scale;
     int len, lenp;
...
static void allocate (malloc_flag)
     int malloc_flag;
