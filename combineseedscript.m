...
%COMBINESEEDSCRIPT combines the result of different seeds (the result has to be combined by fold before)
%   COMBINE_SEEDSCRIPT(FLAG, CLASSNUM, RANDSEED, ALLFLAG, MAXIMGPERFOLD, SDAFLAG, WEIGHTING, CIDX, GIDX, NBRS, CLASSIFIERID)
%
% Input:
...
%
%   See also combine_seed, combine_foldseed
%
