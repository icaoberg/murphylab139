function combinescript(flag, classnum, randseed, allflag, maximgperfold, sdaflag, weightflag, cidx, gidx, nbrs, classifierid)
%COMBINESCRIPT combine results for each fold
%   COMBINESCRIPT(FLAG, CLASSNUM, RANDSEED, ALLFLAG, MAXIMGPERFOLD, SDAFLAG, WEIGHTING, CIDX, GIDX, NBRS, CLASSIFIERID)
%
% Input:
%   FLAG specifiy which feature matrix to use
%   CLASSNUM specify the number of class to classify
%   NFOLD specify the number of fold to use for cross-validation
