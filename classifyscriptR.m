function classifyscriptR(flag, classnum, randseed, allflag, maximgperfold,  sdaflag, weightflag, cidx, gidx, nbrs, classifierid)
%CLASSIFYSCRIPTR runs cell level classification on unique location classes with purality voting scheme for all folds
%   CLASSIFYSCRIPTR(FLAG, CLASSNUM, RANDSEED, ALLFLAG, MAXIMGPERFOLD, SDAFLAG, WEIGHTING, CIDX, GIDX, NBRS, CLASSIFIERID)
%
% Input:
...
%
%   See also sc_classifyyeast, createnfoldscriptR, classifyscript
%
